    ...
    do {
        ...
        switch(opcao) {
            case 1:
                ...
                Genero generoFilme = genero.consultarGenero(idGenero, null);
                if(generoFilme.getId() == 0) {
                    System.out.println("Gênero não encontrado. Cadastre o gênero primeiro");
                    break;
                }

                Filme novoFilme = new Filme(idFilme, titulo, classificacao, generoFilme);
                if(novoFilme.salvar()) {
                ...
                break;
            case 2:
                ArrayList<String[]> filmes = filme.listarFilmes();
                System.out.println("\n=== Lista de Filmes ===");
                for(String[] f : filmes) {
                    System.out.println(String.format("Id: %s | Classificação: %s | Gênero ID: %s | Status: %s%n", f[0], f[1], f[2], f[3], f[4]));
                }
                break;
            case 3:
